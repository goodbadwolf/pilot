#ifndef beams_mpi_transmittancemessenger_h
#define beams_mpi_transmittancemessenger_h

#include "mpi/Messenger.h"
...
protected:
  ...
  VTKM_CONT bool RecvMsg(std::vector<MsgCommType>& msgs)
  {
...
#endif // beams_mpi_transmittancemessenger_h